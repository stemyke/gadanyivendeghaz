      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="text-stone-600 text-lg leading-relaxed space-y-4">
          ...
          <p>
            ...
            látogasson el a Pécsi Állatkertbe, vagy nosztalgiázzon egyet a hangulatos Pécsi Mecsek Kisvasúton!
            Pihenjen az Orfűi-tónál vagy a Hertelendi Termálfürdőben, és csodálja meg az Abaligeti Cseppkőbarlangot.
            Az adrenalin és az aktív kikapcsolódás szerelmeseinek pedig kihagyhatatlan program a Mecsextrém Park,
            amely erdei bobbal, drótkötélpályákkal és számtalan kalandelemmel garantál felejthetetlen élményeket az egész család számára.
          </p>
        </div>
      </div>
    </section>
