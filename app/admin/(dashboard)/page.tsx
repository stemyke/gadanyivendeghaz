...
export default function AdminDashboard() {
  const stats = [
    ...
    { title: 'Galéria képek', value: '28 db', change: 'Utoljára frissítve: ma', icon: ImageIcon, color: 'text-blue-600 bg-blue-50 border-blue-100' },
  ...
  const recentActivities = [
    ...
    { id: 2, type: 'gallery', title: 'Galéria frissítve', description: '3 új kép lett feltöltve a lovardáról', time: '5 órája', status: 'completed' },
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-emerald-950 text-white rounded-2xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-xl md:text-2xl font-serif font-semibold">Üdvözöljük, Admin! 👋</h2>
          <p className="text-emerald-200 text-sm mt-1">Itt kezelheti a vendégház foglalásait, a galériát és az oldal beállításait.</p>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <a href="/admin/gallery" className="flex items-center justify-between p-3 rounded-xl hover:bg-stone-50 border border-transparent hover:border-stone-200 text-sm font-medium text-stone-700 transition">
          ...
          <div className="bg-emerald-50/50 rounded-2xl border border-emerald-100 shadow-sm p-6 text-center space-y-3">
            ...
            <p className="text-xs text-emerald-800/80 leading-relaxed">Ha problémát tapasztal a foglalásokkal vagy a galéria frissítésével kapcsolatban, vegye fel a kapcsolatot a fejlesztővel.</p>
