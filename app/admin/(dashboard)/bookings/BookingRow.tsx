                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-2.5 pl-8 bg-stone-50 rounded-xl border border-stone-200 text-sm focus:border-emerald-500 focus:bg-white outline-none text-stone-800"
                    />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2.5 bg-stone-50 rounded-xl border border-stone-200 text-sm focus:border-emerald-500 focus:bg-white outline-none text-stone-800 cursor-pointer"
                  >
